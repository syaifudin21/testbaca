                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label for="name" class="col-md-4 control-label">Nama Lenkap</label>
                        ...
                        <div class="form-group{{ $errors->has('sekolah') ? ' has-error' : '' }}">
                            <label for="sekolah" class="col-md-4 control-label">Sekolah</label>

                            <div class="col-md-6">
                                <input id="sekolah" type="text" class="form-control" name="sekolah" required>
